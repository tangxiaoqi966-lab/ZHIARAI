          ...
          <PopoverAnchor_Shadcn_ asChild>
            {isRootGroup ? (
              <Input_Shadcn_
                ...
                placeholder={
                  group.conditions.length === 0 ? emptyPlaceholder : (t ? t('filter_bar.placeholder.add_more_filters') : 'Add more filters...')
                }
                disabled={isLoading}
              ...
              <div className="relative inline-block">
                <Input_Shadcn_
                  ...
                  placeholder={t ? t('filter_bar.placeholder.add_filter') : "+ Add filter"}
                  disabled={isLoading}
                  autoComplete="off"
                  data-1p-ignore
                  data-lpignore="true"
