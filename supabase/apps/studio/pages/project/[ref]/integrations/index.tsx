...
const IntegrationsPage: NextPageWithLayout = () => {
  ...
  const pageContent = useMemo(() => {
    switch (selectedCategory) {
      case 'wrapper':
        return {
          title: t('integrations.page_titles.wrappers'),
          subtitle: t('integrations.page_descriptions.wrappers'),
          secondaryActions: (
      ...
      case 'postgres_extension':
        return {
          title: t('integrations.page_titles.postgres_modules'),
          subtitle: t('integrations.page_descriptions.postgres_modules'),
        }
      default:
        return {
          title: t('integrations.page_titles.extend_your_database'),
          subtitle: t('integrations.page_descriptions.extend_your_database'),
        }
    }
  }, [selectedCategory, t])
      ...
      <PageContainer size="large">
        <PageSection>
          ...
          <PageSectionContent>
            ...
            {/* Error State */}
            {isError && (
              <AlertError subject={t('integrations.errors.failed_to_retrieve_available')} error={error} />
            )}
