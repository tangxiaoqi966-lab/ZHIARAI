  ...
  if (isError) {
    return (
      <div className="my-8 mx-4 flex flex-col items-center gap-2">
        ...
        <h2 className="text-base text-foreground-light">{t('advisor.error_loading_advisories')}</h2>
        <p className="text-sm text-foreground-lighter">{t('advisor.please_try_again_later')}</p>
      </div>
    )
  }
