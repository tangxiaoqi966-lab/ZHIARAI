    ...
    <div className="flex-1 overflow-y-auto">
      <div className="w-full flex-1 max-h-full min-h-full px-4 flex flex-col gap-0">
        <div className="mt-auto w-full space-y-6 py-8 ">
          <h2 className="heading-section text-foreground mx-4">{t('ai_assistant.how_can_i_assist_you')}</h2>
          {suggestions?.prompts?.length ? (
            <div>
              <h3 className="heading-meta text-foreground-light mb-3 mx-4">{t('ai_assistant.suggestions')}</h3>
              ...
              {isLintsLoading ? (
                ...
                <>
                  {performanceErrorLints.length > 0 && (
                    <div className="mb-4">
                      <h3 className="heading-meta text-foreground-light mb-3 mx-4">
                        {t('ai_assistant.improve_performance')}
                      </h3>
                  ...
                  {securityErrorLints.length > 0 && (
                    <div className="mb-4">
                      <h3 className="heading-meta text-foreground-light mb-3 mx-4">
                        {t('ai_assistant.improve_security')}
                      </h3>
                  ...
                  <div>
                    <h3 className="heading-meta text-foreground-light mb-3 mx-4">{t('ai_assistant.ideas')}</h3>
                    {prompts.map((item, index) => (
                      <Button
