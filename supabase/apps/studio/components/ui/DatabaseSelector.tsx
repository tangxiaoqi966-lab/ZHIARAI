              ...
              <>
                <span className="capitalize">
                  {isLoading || selectedDatabase?.identifier === projectRef
                    ? t('common.primary_database')
                    : t('common.read_replica')}
                </span>{' '}
                      ...
                      <Tooltip key={database.identifier}>
                        <TooltipTrigger asChild>
                          <div className="px-2 py-1.5 w-full flex items-center justify-between">
                            <p className="text-xs text-foreground-lighter">
                              {t('common.read_replica')} ({region} - {id})
                            </p>
                          </div>
                        </TooltipTrigger>
                        <TooltipContent side="right" className="w-80">
                          <Markdown
                            ...
                            content={t('common.replica_status_unhealthy', { status, link: `/project/${projectRef}/settings/infrastructure` })}
                          />
                        </TooltipContent>
                      </Tooltip>
                    )
              ...
              <CommandGroup_Shadcn_ className="border-t">
                ...
                >
                  ...
                  >
                    ...
                    <p>{t('common.create_new_read_replica')}</p>
                  </Link>
                </CommandItem_Shadcn_>
              </CommandGroup_Shadcn_>
            )}
