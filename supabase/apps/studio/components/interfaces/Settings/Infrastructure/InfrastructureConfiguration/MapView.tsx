                  ...
                  setTooltip({
                    ...
                    region: {
                      ...
                      name: hasNoDatabases
                        ...
                        : hasPrimary
                          ? replicas.length > 0
                            ? t('settings.infrastructure.map_primary_with_replicas', {
                                count: replicas.length,
                              })
                            : t('settings.infrastructure.primary_database')
                          : t('settings.infrastructure.map_replicas_deployed', {
                              count: replicas.length,
                            }),
                    },
                  })
              ...
              <foreignObject width={220} height={66.25}>
                <div className="bg-studio/50 rounded border">
                  <div className="px-3 py-2 flex flex-col">
                    ...
                    >
                      {tooltip.region.name ?? t('settings.infrastructure.no_databases_deployed')}
                    </p>
                  </div>
                </div>
              </foreignObject>
          ...
          <div className="flex items-center justify-between py-4 px-4 border-b">
            <div>
              <p className="text-xs text-foreground-light">
                {t('settings.infrastructure.databases_deployed_in', {
                  count: databasesInSelectedRegion.length,
                })}
              </p>
                  ...
                  return (
                    ...
                    >
                      <div className="flex flex-col gap-y-1">
                        <p className="flex items-center gap-x-2">
                          {database.identifier === ref
                            ...
                            : database.identifier.length > 0
                              ? t('settings.infrastructure.read_replica_with_id', {
                          ...
                          {database.status === REPLICA_STATUS.ACTIVE_HEALTHY ? (
                            <Badge variant="success">
                              {t('settings.infrastructure.replica_status.healthy')}
                            </Badge>
                            ...
                            <Badge variant="warning">
                              {t('settings.infrastructure.replica_status.unhealthy')}
                            </Badge>
                          )}
                        </p>
                        <p className="text-xs text-foreground-light">
                        ...
                        {database.identifier !== ref && (
                          <p className="text-xs text-foreground-light">
                            {t('settings.infrastructure.created_on', { created })}
                          </p>
                        )}
                      </div>
                      {database.identifier !== ref && (
                          ...
                          <DropdownMenuContent className="w-40" side="bottom" align="end">
                            ...
                            <DropdownMenuItemTooltip
                              ...
                              tooltip={{
                                content: {
                                  side: 'left',
                                  text: t('settings.infrastructure.drop_replica_permission_error'),
                                },
                              }}
                            >
