export const getEdgeFunctionTemplates = (t: any) => [
  {
    value: 'hello-world',
    name: t('functions.templates.hello_world_name'),
    description: t('functions.templates.hello_world_desc'),
...
Deno.serve(async (req: Request) => {
  ...
  },
  {
    ...
    name: t('functions.templates.database_access_name'),
    description: t('functions.templates.database_access_desc'),
    content: `// Setup type definitions for built-in Supabase Runtime APIs
import "jsr:@supabase/functions-js/edge-runtime.d.ts";
...
Deno.serve(async (req) => {
  ...
  },
  {
    ...
    name: t('functions.templates.storage_upload_name'),
    description: t('functions.templates.storage_upload_desc'),
    content: `// Setup type definitions for built-in Supabase Runtime APIs
import "jsr:@supabase/functions-js/edge-runtime.d.ts";
import { createClient } from 'jsr:@supabase/supabase-js@2'
...
Deno.serve(async (req) => {
  ...
  {
    value: 'node-api',
    name: t('functions.templates.node_api_name'),
    description: t('functions.templates.node_api_desc'),
    content: `// Setup type definitions for built-in Supabase Runtime APIs
import "jsr:@supabase/functions-js/edge-runtime.d.ts";
...
server.listen(9999);`,
  ...
  {
    value: 'express',
    name: t('functions.templates.express_name'),
    description: t('functions.templates.express_desc'),
    content: `// Setup type definitions for built-in Supabase Runtime APIs
import "jsr:@supabase/functions-js/edge-runtime.d.ts";
...
app.listen(8000);`,
  },
  {
    ...
    name: t('functions.templates.ai_stream_name'),
    description: t('functions.templates.ai_stream_desc'),
    content: `/*
...
Deno.serve(async (req) => {
  ...
  },
  {
    ...
    name: t('functions.templates.ai_recipes_name'),
    description: t('functions.templates.ai_recipes_desc'),
    content: `/*
...
Deno.serve(async (req) => {
  ...
  },
  {
    ...
    name: t('functions.templates.stripe_webhook_name'),
    description: t('functions.templates.stripe_webhook_desc'),
    content: `// Setup type definitions for built-in Supabase Runtime APIs
import "jsr:@supabase/functions-js/edge-runtime.d.ts";
...
Deno.serve(async (request) => {
  ...
  {
    value: 'resend-email',
    name: t('functions.templates.send_emails_name'),
    description: t('functions.templates.send_emails_desc'),
    content: `// Setup type definitions for built-in Supabase Runtime APIs
import "jsr:@supabase/functions-js/edge-runtime.d.ts";
...
Deno.serve(async (req) => {
  ...
  },
  {
    ...
    name: t('functions.templates.image_transform_name'),
    description: t('functions.templates.image_transform_desc'),
    content: `// Setup type definitions for built-in Supabase Runtime APIs
import "jsr:@supabase/functions-js/edge-runtime.d.ts";
import {
  ImageMagick,
...
Deno.serve(async (req) => {
  ...
  },
  {
    ...
    name: t('functions.templates.websocket_name'),
    description: t('functions.templates.websocket_desc'),
    content: `// Setup type definitions for built-in Supabase Runtime APIs
import "jsr:@supabase/functions-js/edge-runtime.d.ts";
