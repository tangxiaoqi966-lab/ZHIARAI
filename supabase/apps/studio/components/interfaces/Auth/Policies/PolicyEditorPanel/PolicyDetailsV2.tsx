        ...
        <div className="items-start justify-between gap-4 grid grid-cols-12">
          <FormField_Shadcn_
            ...
            render={({ field }: { field: any }) => (
              <FormItem_Shadcn_ className="col-span-6 flex flex-col gap-y-1">
                <FormLabel_Shadcn_>{t('auth_policies.policy_name')}</FormLabel_Shadcn_>
                <FormControl_Shadcn_>
                  <Input_Shadcn_
                    {...field}
                    disabled={!canUpdatePolicies}
                    className="bg-control border-control"
                    placeholder={t('auth_policies.policy_name_placeholder')}
                  />
                </FormControl_Shadcn_>
                <FormMessage_Shadcn_ />
              </FormItem_Shadcn_>
                ...
                {authContext === 'database' && (
                  <FormControl_Shadcn_>
                    <Popover_Shadcn_ open={open} onOpenChange={setOpen} modal={false}>
                      ...
                      >
                        <Command_Shadcn_>
                          <CommandInput_Shadcn_ placeholder={t('auth_policies.find_table')} />
                          <CommandList_Shadcn_>
                            <CommandEmpty_Shadcn_>{t('auth_policies.no_tables_found')}</CommandEmpty_Shadcn_>
                            <CommandGroup_Shadcn_>
          ...
          <FormField_Shadcn_
            ...
            render={({ field }: { field: any }) => (
              <FormItem_Shadcn_ className="col-span-6 flex flex-col gap-y-1">
                <FormLabel_Shadcn_>
                  {t('auth_policies.policy_behavior')} <code className="text-code-inline">as</code> clause
                </FormLabel_Shadcn_>
                <FormControl_Shadcn_>
                  <Select_Shadcn_
                    disabled={isEditing}
                    value={field.value}
                    onValueChange={(value: string) => form.setValue('behavior', value)}
                  >
                      ...
                      <SelectGroup_Shadcn_>
                        <SelectItem_Shadcn_ value="permissive" className="text-sm">
                          ...
                          <p className="text-foreground-light text-xs">
                            {t('auth_policies.permissive_description')}
                          </p>
                        </SelectItem_Shadcn_>
                        <SelectItem_Shadcn_ value="restrictive" className="text-sm">
                          <p>Restrictive</p>
                          <p className="text-foreground-light text-xs">
                            {t('auth_policies.restrictive_description')}
                          </p>
                        </SelectItem_Shadcn_>
                      </SelectGroup_Shadcn_>
                    </SelectContent_Shadcn_>
          ...
          <FormField_Shadcn_
            ...
            render={({ field }: { field: any }) => (
              <FormItem_Shadcn_ className="col-span-12 flex flex-col gap-y-1">
                <FormLabel_Shadcn_>
                  {t('auth_policies.policy_command')} <code className="text-code-inline">for</code> clause
                </FormLabel_Shadcn_>
                <FormControl_Shadcn_>
                  <RadioGroup_Shadcn_
                    disabled={isEditing}
          ...
          <FormField_Shadcn_
            ...
            render={({ field }: { field: any }) => (
              <FormItem_Shadcn_ className="col-span-12 flex flex-col gap-y-1">
                <FormLabel_Shadcn_>
                  {t('auth_policies.target_roles')} <code className="text-code-inline">to</code> clause
                </FormLabel_Shadcn_>
                <FormControl_Shadcn_>
                  <MultiSelectV2
                    disabled={!canUpdatePolicies}
                    ...
                    placeholder={t('auth_policies.target_roles_placeholder')}
                    searchPlaceholder={t('auth_policies.search_role')}
