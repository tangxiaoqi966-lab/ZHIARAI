...
export const getQueryPerformanceColumns = (t: any) => [
  { id: 'query', name: t('advisor.table.query'), description: undefined, minWidth: 500 },
  { id: 'prop_total_time', name: t('advisor.table.time_consumed'), description: undefined, minWidth: 150 },
  { id: 'calls', name: t('advisor.table.calls'), description: undefined, minWidth: 100 },
  { id: 'max_time', name: t('advisor.table.max_time'), description: undefined, minWidth: 100 },
  { id: 'mean_time', name: t('advisor.table.mean_time'), description: undefined, minWidth: 100 },
  { id: 'min_time', name: t('advisor.table.min_time'), description: undefined, minWidth: 100 },
  { id: 'rows_read', name: t('advisor.table.rows_processed'), description: undefined, minWidth: 130 },
  { id: 'cache_hit_rate', name: t('advisor.table.cache_hit_rate'), description: undefined, minWidth: 130 },
  { id: 'rolname', name: t('advisor.table.role'), description: undefined, minWidth: 200 },
  { id: 'application_name', name: t('advisor.table.application'), description: undefined, minWidth: 150 },
] as const
