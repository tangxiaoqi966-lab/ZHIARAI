            ...
            <TableRow>
              ...
              >
                <TableHeadSort
                  ...
                  className={cn(noResults && 'text-foreground-muted')}
                >
                  {t('home.project_list.project')}
                </TableHeadSort>
              </TableHead>
              <TableHead className={cn(noResults && 'text-foreground-muted')}>{t('home.project_list.status')}</TableHead>
              <TableHead className={cn(noResults && 'text-foreground-muted')}>{t('home.project_list.compute')}</TableHead>
              <TableHead className={cn(noResults && 'text-foreground-muted')}>{t('home.project_list.region')}</TableHead>
              <TableHead
                className={cn(noResults && 'text-foreground-muted')}
                aria-sort={getProjectListAriaSort(sort)}
              >
              ...
              <TableRow className="[&>td]:hover:bg-inherit">
                <TableCell colSpan={6}>
                  <NoSearchResults
                    ...
                    label={
                      filterStatus.length === 0
                        ? t('home.project_list.no_projects')
                        : filterStatus[0] === 'INACTIVE' ? t('home.project_list.no_paused_projects') : t('home.project_list.no_active_projects')
                    }
                    description={t('home.project_list.no_results_desc')}
