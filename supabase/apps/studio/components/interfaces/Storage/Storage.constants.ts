...
export const getBucketTypes = (t: any) => ({
  files: {
    displayName: t('storage.files'),
    singularName: 'file',
    article: 'a',
    description: t('storage.general_storage_description'),
    valueProp: t('storage.general_storage_value_prop'),
