              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent side="top" align="start" className="w-40">
                  <DropdownMenuRadioGroup
                    ...
                    onValueChange={(value: string) => setSidebarBehaviour(value as SidebarBehaviourType)}
                  >
...
const ProjectLinks = () => {
  ...
  const toolRoutes = generateToolRoutes(ref, project, {}, t)
  ...
  const settingsRoutes = generateSettingsRoutes(ref, project, t)
...
const OrganizationLinks = () => {
  ...
  const navMenuItems = [
    ...
    {
      label: t('navigation.settings.usage'),
    ...
    ...(showBilling
      ? [
          {
            label: t('navigation.settings.billing'),
      ...
      : []),
    {
      label: t('navigation.settings.configuration'),
