    ...
    >
      <SidePanel.Content className="space-y-10 py-6">
        ...
        <Input
          ...
          placeholder={t('table_editor.description_optional')}
          layout="horizontal"
          type="text"
          ...
          <SidePanel.Content className="space-y-10 py-6">
            <Checkbox
              ...
              label={
                <div className="flex items-center space-x-2">
                  <span>{t('table_editor.enable_rls')}</span>
                  <Badge>{t('table_editor.recommended')}</Badge>
                </div>
              }
              description={t('table_editor.enable_rls_description')}
            ...
            {tableFields.isRLSEnabled ? (
              <Admonition
                type="default"
                className="!mt-3"
                title={t('table_editor.rls_required_title')}
                description={
                  <>
                    <Trans
                      i18nKey="table_editor.rls_required_description"
                      values={{ isNewRecord: isNewRecord ? t('table_editor.rls_create_after_saving') : '' }}
                      components={{ 1: <u className="text-foreground" /> }}
                    />
                  </>
                }
              >
              ...
              <Admonition
                type="warning"
                className="!mt-3"
                title={t('table_editor.rls_anonymous_title')}
                description={
                  t('table_editor.rls_anonymous_description', { tableName: tableFields.name ? `The table ${tableFields.name}` : 'Your table' })
                }
              >
                <DocsButton
                  abbrev={false}
            ...
            {realtimeEnabled && (
              <Checkbox
                id="enable-realtime"
                label={t('table_editor.enable_realtime')}
                description={t('table_editor.enable_realtime_description')}
      ...
      <SidePanel.Content className="space-y-10 py-6">
        ...
        {isDuplicating && (
          <>
            <Checkbox
              id="duplicate-rows"
              label={t('table_editor.duplicate_rows')}
              description={t('table_editor.duplicate_rows_description')}
        ...
        {!generatePoliciesEnabled && (
          <ConfirmationModal
            ...
            title={t('table_editor.turn_off_rls')}
            confirmLabel={t('table_editor.confirm')}
            size="medium"
