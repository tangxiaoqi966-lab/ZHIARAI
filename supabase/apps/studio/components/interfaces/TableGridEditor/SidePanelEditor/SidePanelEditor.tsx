...
const CloseConfirmationModal = ({ visible, onClose, onCancel }: ConfirmOnCloseModalProps) => {
  ...
  return (
    <ConfirmationModal
      visible={visible}
      title={t('table_editor.discard_changes')}
      confirmLabel={t('table_editor.discard')}
      onCancel={onCancel}
      onConfirm={onClose}
    >
      <p className="text-sm text-foreground-light">{t('table_editor.discard_changes_description')}</p>
    </ConfirmationModal>
  )
}
