...
const SUPABASE_INTEGRATIONS: Array<IntegrationDefinition> = [
  {
    ...
    get name() { return t('integrations.queues.name') },
    icon: ({ className, ...props } = {}) => (
      <Layers className={cn('inset-0 p-2 text-black w-full h-full', className)} {...props} />
    ),
    get description() { return t('integrations.queues.description') },
  ...
  },
  {
    ...
    get name() { return t('integrations.cron.name') },
    icon: ({ className, ...props } = {}) => (
      <Clock5 className={cn('inset-0 p-2 text-black w-full h-full', className)} {...props} />
    ),
    get description() { return t('integrations.cron.description') },
  ...
  },
  {
    ...
    get name() { return t('integrations.vault.name') },
    status: 'beta',
    icon: ({ className, ...props } = {}) => (
      <Vault className={cn('inset-0 p-2 text-black w-full h-full', className)} {...props} />
    ),
    get description() { return t('integrations.vault.description') },
    docsUrl: DOCS_URL,
  ...
  },
  {
    id: 'webhooks',
    type: 'postgres_extension' as const,
    get name() { return t('integrations.webhooks.name') },
    icon: ({ className, ...props } = {}) => (
      <Webhook className={cn('inset-0 p-2 text-black w-full h-full', className)} {...props} />
    ),
    get description() { return t('integrations.webhooks.description') },
    docsUrl: DOCS_URL,
    author: authorSupabase,
    requiredExtensions: [],
    navigation: [
  ...
  },
  {
    ...
    requiredExtensions: [],
    get name() { return t('integrations.data_api.name') },
    icon: ({ className, ...props } = {}) => (
      <Code2 className={cn('inset-0 p-2 text-black w-full h-full', className)} {...props} />
    ),
    get description() { return t('integrations.data_api.description') },
  ...
  },
  {
    ...
    get name() { return t('integrations.graphql.name') },
    icon: ({ className, ...props } = {}) => (
      <Image
        fill
    ...
    get description() { return t('integrations.graphql.description') },
    docsUrl: DOCS_URL,
    author: authorSupabase,
    navigation: [
      {
...
const TEMPLATE_INTEGRATIONS: Array<IntegrationDefinition> = [
  {
    ...
    missingExtensionsAlert: <UpgradeDatabaseAlert minimumVersion="15.6.1.143" />,
    get name() { return t('integrations.stripe_sync_engine.name') },
    status: 'alpha',
    icon: ({ className, ...props } = {}) => (
      <Image
        fill
    ...
    get description() { return t('integrations.stripe_sync_engine.description') },
