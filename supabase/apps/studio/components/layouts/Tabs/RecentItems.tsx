...
export function RecentItems() {
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-sm text-foreground">{t('recent_items.title')}</h2>
      <div className="flex flex-col gap-0">
        {sortedItems.length === 0 ? (
          ...
          >
            ...
            <div>
              <p className="text-xs text-foreground-light">{t('recent_items.empty_title')}</p>
              <p className="text-xs text-foreground-lighter">
                {t('recent_items.empty_desc')}
              </p>
            </div>
          </motion.div>
        ) : (
