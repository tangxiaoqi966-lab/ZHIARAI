        ...
        <div className="flex flex-col gap-y-1.5">
          ...
          <div className="grid gap-3 mx-4">
            {!isSchemaLocked ? (
              <ButtonTooltip
                block
                title={t('table_editor_sidebar_menu.menu.create_table_title')}
                name={t('table_editor_sidebar_menu.menu.new_table')}
                ...
                tooltip={{
                  content: {
                    ...
                    text: !canCreateTables
                      ? t('table_editor_sidebar_menu.menu.create_table_permission_error')
                      : undefined,
                  },
                }}
              >
        ...
        <div className="grow min-h-0 flex flex-col gap-2 pb-4">
          <InnerSideBarFilters className="mx-2">
            <InnerSideBarFilterSearchInput
              ...
              name="search-tables"
              value={searchText}
              placeholder={t('table_editor_sidebar_menu.menu.search_tables_placeholder')}
              aria-labelledby={t('table_editor_sidebar_menu.menu.search_tables_label')}
            ...
            >
              ...
              >
                ...
                >
                  {t('table_editor_sidebar_menu.menu.sort_alphabetical')}
                </InnerSideBarFilterSortDropdownItem>
                <InnerSideBarFilterSortDropdownItem
                  key="grouped-alphabetical"
                  value="grouped-alphabetical"
                >
                  {t('table_editor_sidebar_menu.menu.sort_entity_type')}
                </InnerSideBarFilterSortDropdownItem>
              </InnerSideBarFilterSortDropdown>
            </InnerSideBarFilterSearchInput>
            <Popover_Shadcn_>
