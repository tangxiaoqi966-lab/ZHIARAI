...
exports.batchUpdateApiKeys = exports.enableApiKey = exports.revokeApiKey = exports.validateApiKey = exports.rotateApiKey = exports.deleteApiKey = exports.updateApiKey = exports.createApiKey = exports.getApiKey = exports.listApiKeys = void 0;
const service_1 = require("./service");
const types_1 = require("./types");
const apiKeyService = new service_1.ApiKeyService();
// 获取请求中的项目引用（从路径参数或头部）
...
exports.enableApiKey = enableApiKey;
// 批量操作：启用/禁用多个 API 密钥
const batchUpdateApiKeys = async (req, res) => {
    try {
        const projectRef = getProjectRef(req);
        const userId = getUserId(req);
        const { ipAddress, userAgent } = getClientInfo(req);
...
exports.batchUpdateApiKeys = batchUpdateApiKeys;
